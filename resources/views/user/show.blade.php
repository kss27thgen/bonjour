...
@section('content')
    <div class="tweets">
        ...
        <div class="tweets-header">
            <p class="tweets-header-name">{{ $tweets->first()->user->name }}'s tweets</p>
            @if ($tweets->first()->user->name != Auth::user()->name)
                <a href="{{ route('users.follow', $tweets->first()->user) }}" class="tweets-header-button">Follow</a>
            @endif
        </div>
